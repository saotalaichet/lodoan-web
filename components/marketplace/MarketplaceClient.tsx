  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="relative text-white py-16 md:py-24 px-4 overflow-hidden" style={{background: '#A32020'}}>
        ...
        <img src="https://res.cloudinary.com/dvnssii5h/image/upload/f_auto,q_auto,w_300/pizza_rk3cau_e3p7vn.png" alt="" aria-hidden="true" className="hidden lg:block absolute top-0 right-0 w-32 xl:w-40 translate-x-4 -translate-y-1/3 select-none pointer-events-none" />
        ...
        <img src="https://res.cloudinary.com/dvnssii5h/image/upload/f_auto,q_auto,w_300/poke_s5txe1_ejikuz.png" alt="" aria-hidden="true" className="hidden lg:block absolute top-[35%] right-0 w-32 xl:w-40 translate-x-4 select-none pointer-events-none" />

...
const HEADING_FONT = 'var(--font-jakarta, "Plus Jakarta Sans", sans-serif)';
...
function RestaurantCard({ restaurant, lang }: { restaurant: Restaurant; lang: string }) {
    ...
    <Link href={`/${restaurant.slug}`} className="block">
      ...
      >
          ...
          <div className="absolute flex items-center justify-center overflow-hidden"
            ...
            {restaurant.logo ? (
              ...
              <div className="w-full h-full rounded-full flex items-center justify-center" style={{ background: PRIMARY }}>
                <span style={{ color: 'white', fontSize: '14px', fontWeight: '700', fontFamily: HEADING_FONT }}>{firstLetter}</span>
              </div>
            )}
          </div>
        </div>
        ...
        <div className="flex flex-col flex-1" style={{ padding: '24px 14px 14px 14px' }}>
          <h3 className="font-bold leading-tight mb-1.5" style={{ fontSize: '15px', color: '#1A1A1A', fontFamily: HEADING_FONT }}>
            {restaurant.name}
          </h3>
          {cuisineLabel && (
          ...
          <button
            ...
            style={isOpen
              ? { background: PRIMARY, color: 'white', fontFamily: HEADING_FONT }
              : { background: '#D3D3D3', color: '#666', cursor: 'not-allowed', fontFamily: HEADING_FONT }
            }>
            {isOpen
    ...
    <div className="min-h-screen flex flex-col" style={{ background: 'hsl(30, 20%, 97%)' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 lg:px-8 h-16 flex items-center gap-4">
          <Link href="/" className="flex items-center flex-shrink-0" style={{ gap: '10px' }}>
            ...
            <div className="leading-none">
              <div className="font-black text-xl tracking-tight leading-none" style={{ color: PRIMARY, fontFamily: HEADING_FONT }}>LÒ ĐỒ ĂN</div>
          ...
          <div className="flex items-center gap-3 ml-auto">
            ...
            <Link href="/signup" className="text-white text-sm font-bold px-4 py-2 rounded-lg hover:opacity-90 transition-opacity"
              style={{ backgroundColor: PRIMARY, fontFamily: HEADING_FONT }}>
      ...
      <div className="text-white py-14 px-4"
        ...
        <div className="max-w-3xl mx-auto text-center">
          <h1 className="font-black mb-3 leading-tight"
            style={{ fontSize: 'clamp(2rem, 5vw, 3rem)', fontFamily: HEADING_FONT }}>
      ...
      <div className="max-w-7xl mx-auto px-4 lg:px-8 py-8 flex-1 w-full">
        ...
        <div className="mb-4 flex items-center justify-between">
          <h2 className="font-bold text-gray-900 text-xl" style={{ fontFamily: HEADING_FONT }}>
        ...
        {filtered.length === 0 ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-700 text-lg font-semibold" style={{ fontFamily: HEADING_FONT }}>
              {lang === 'vi' ? 'Chưa có nhà hàng nào.' : 'No restaurants found.'}
            </p>
          </div>
        ) : (
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center mb-3" style={{ gap: '10px' }}>
                <Image src="https://i.postimg.cc/wj17FHhc/Ovenly-logo-1-(3).png" alt="Ovenly" width={44} height={44} className="object-contain" style={{ height: '44px', width: 'auto' }} />
                <div className="leading-none">
                  <div className="font-black text-2xl leading-none" style={{ color: PRIMARY, fontFamily: HEADING_FONT }}>LÒ ĐỒ ĂN</div>

...
export default function MarketplaceClient() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      {/* HERO */}
      <div className="relative text-white py-14 md:py-20 px-4 overflow-hidden" style={{background: '#A32020'}}>
        <img src="https://res.cloudinary.com/dvnssii5h/image/upload/f_auto,q_auto,w_400/dumplings_uftyxf.png" alt="" aria-hidden="true" className="hidden lg:block absolute top-0 left-0 w-48 xl:w-56 -translate-x-8 -translate-y-6 select-none pointer-events-none" />
        <img src="https://res.cloudinary.com/dvnssii5h/image/upload/f_auto,q_auto,w_400/pizza_rk3cau.png" alt="" aria-hidden="true" className="hidden lg:block absolute top-0 right-0 w-48 xl:w-56 translate-x-8 -translate-y-6 select-none pointer-events-none" />
        <img src="https://res.cloudinary.com/dvnssii5h/image/upload/f_auto,q_auto,w_400/banhmi_yvelxm.png" alt="" aria-hidden="true" className="hidden lg:block absolute bottom-0 left-0 w-56 xl:w-64 -translate-x-12 translate-y-6 select-none pointer-events-none" />
        <img src="https://res.cloudinary.com/dvnssii5h/image/upload/f_auto,q_auto,w_400/poke_s5txe1.png" alt="" aria-hidden="true" className="hidden lg:block absolute bottom-0 right-0 w-48 xl:w-56 translate-x-8 translate-y-6 select-none pointer-events-none" />

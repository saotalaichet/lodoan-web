  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="relative text-white py-14 px-4 overflow-hidden" style={{background: '#A32020'}}>
        {/* Top-left: dumplings */}
        <img src="https://res.cloudinary.com/dvnssii5h/image/upload/w_220,h_220,c_fit/dumplings_uftyxf.png" alt="" className="hidden md:block absolute top-0 left-0 select-none pointer-events-none" style={{width:'220px', transform:'translate(-48px, -24px)'}} />
        {/* Top-right: pizza */}
        <img src="https://res.cloudinary.com/dvnssii5h/image/upload/w_220,h_220,c_fit/pizza_rk3cau.png" alt="" className="hidden md:block absolute top-0 right-0 select-none pointer-events-none" style={{width:'220px', transform:'translate(48px, -24px)'}} />
        {/* Bottom-left: banh mi */}
        <img src="https://res.cloudinary.com/dvnssii5h/image/upload/w_280,h_180,c_fit/banhmi_yvelxm.png" alt="" className="hidden md:block absolute bottom-0 left-0 select-none pointer-events-none" style={{width:'280px', transform:'translate(-64px, 16px)'}} />
        {/* Bottom-right: poke bowl */}
        <img src="https://res.cloudinary.com/dvnssii5h/image/upload/w_220,h_220,c_fit/poke_s5txe1.png" alt="" className="hidden md:block absolute bottom-0 right-0 select-none pointer-events-none" style={{width:'220px', transform:'translate(48px, 24px)'}} />

            ...
            <div key={i} className="ov-card-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', background: '#fff', border: `1px solid ${BORDER}`, borderRadius: 20, overflow: 'hidden' }}>
              ...
              <div className="ov-card-photo" style={{ order: p.flip ? 0 : 1, minHeight: 420, overflow: 'hidden', position: 'relative', background: '#FDEEEA', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '40px 32px' }}>
                {i === 0 ? (
                  <div style={{ width: '100%', maxWidth: 600, borderRadius: 12, overflow: 'hidden', boxShadow: '0 24px 80px rgba(0,0,0,0.18)', border: '1px solid #ddd' }}>
                    ...
                    <div style={{ background: '#e8e8e8', padding: '0 12px', borderBottom: '1px solid #c8c8c8' }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 8, height: 40 }}>
                        ...
                        <div style={{ flex: 1, background: '#fff', borderRadius: 20, padding: '4px 12px', fontSize: 11, color: '#555', border: '1px solid #d0d0d0', display: 'flex', alignItems: 'center', gap: 5 }}>
                  ...
                  <div style={{ position: 'relative', width: 150, flexShrink: 0 }}><div style={{ width: '100%', background: '#0a0a0a', borderRadius: 38, padding: 3, boxShadow: '0 0 0 0.5px #222, 0 20px 50px rgba(0,0,0,0.4)' }}><div style={{ position: 'absolute', right: -2, top: 80, width: 2, height: 44, background: '#1a1a1a', borderRadius: '0 2px 2px 0' }} /><div style={{ position: 'absolute', left: -2, top: 70, width: 2, height: 24, background: '#1a1a1a', borderRadius: '2px 0 0 2px' }} /><div style={{ position: 'absolute', left: -2, top: 104, width: 2, height: 24, background: '#1a1a1a', borderRadius: '2px 0 0 2px' }} /><div style={{ borderRadius: 36, overflow: 'hidden' }}>
                    <video

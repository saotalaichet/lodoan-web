  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="font-heading text-3xl font-black text-primary mb-8">{lang === 'vi' ? 'Giải Quyết Khiếu Nại' : 'Dispute Resolution'}</h1>
        <div className="bg-white rounded-2xl p-8 space-y-6 text-gray-700 leading-relaxed" style={{ boxShadow: '0 1px 4px rgba(0,0,0,0.06)' }}>
          {lang === 'vi' ? (<>
            <section><h2 className="font-heading font-bold text-lg text-gray-900 mb-3">Quy Trình Khiếu Nại</h2><p>Chúng tôi cam kết giải quyết mọi khiếu nại một cách công bằng và nhanh chóng. Để gửi khiếu nại, vui lòng liên hệ qua email <a href="mailto:hello@ovenly.io" className="text-primary underline">hello@ovenly.io</a> với tiêu đề "Khiếu Nại - [Mã Đơn Hàng]".</p></section>
            ...
            <section><h2 className="font-heading font-bold text-lg text-gray-900 mb-3">Liên Hệ Trực Tiếp</h2><p>Email: <a href="mailto:hello@ovenly.io" className="text-primary underline">hello@ovenly.io</a><br/>Giờ làm việc: 8:00 - 22:00, Thứ Hai - Chủ Nhật</p></section>
          </>) : (<>
            <section><h2 className="font-heading font-bold text-lg text-gray-900 mb-3">Claims Process</h2><p>We are committed to resolving all complaints fairly and promptly. To submit a claim, please contact us at <a href="mailto:hello@ovenly.io" className="text-primary underline">hello@ovenly.io</a> with the subject "Claim - [Order ID]".</p></section>
            ...
            <section><h2 className="font-heading font-bold text-lg text-gray-900 mb-3">Direct Contact</h2><p>Email: <a href="mailto:hello@ovenly.io" className="text-primary underline">hello@ovenly.io</a><br/>Hours: 8:00 AM - 10:00 PM, Monday - Sunday</p></section>
          </>)}
        </div>
      </div>
    </div>

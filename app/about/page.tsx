  ...
  return (
    <div className="min-h-screen" style={{ background: 'hsl(30,20%,97%)' }}>
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        <h1 className="font-heading text-3xl font-black mb-6" style={{ color: PRIMARY }}>
        ...
        <div className="text-white rounded-2xl p-8 mb-6" style={{ backgroundColor: PRIMARY }}>
          ...
          <Link href="/contact"
            className="inline-block mt-4 bg-white font-bold px-6 py-3 rounded-xl hover:bg-gray-50 transition-colors"
            style={{ color: PRIMARY }}>
